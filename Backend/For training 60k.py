...
categories = {'sex': ['other', 'm', 'f'],
              ...
              'body_type': ['other', 'skinny', 'thin', 'average', 'fit', 'athletic', 'curvy', 'a little extra',
                            'full figured', 'jacked'],
              ...
              'education': ['other', 'high school', 'graduated from high school', 'working on college/university',
                            'graduated from college/university', 'working on masters program',
              ...
              'ethnicity': ['other', 'white', 'native american', 'middle eastern', 'hispanic', 'black', 'asian',
                            'pacific islander', 'indian'],
              'job': ['other', 'transportation', 'hospitality', 'student', 'artistic', 'computer science', 'science',
                      'banking', 'sales',
              ...
              'religion': ['other', 'atheism', 'agnosticism', 'hindiusm', 'buddhism', 'judaism', 'christianity',
                           'catholicism'],
              'smokes': ['other', "no", "trying to quit", "sometimes", "when drinking", "yes"],
              'speaks': ['other', "english", "spanish", "french", "german", "sign language", "italian", "japanese",
                         "russian", "gujarati",
...
100 means they are as attractive as a person can possibly be''')
            ...
            training_examples = make_features_all(
                [list(training_examples.iloc[i]) for i in range(training_examples.shape[0])])
...
def add_random_neighbors_and_lin_class_users(max_friends=25, num_distinct=60000, num_examples=20):
    ...
    for i in range(num_distinct):
        ...
        training_examples = make_features_all(
            [list(population.iloc[ids[(i * num_examples + j) % len(ids)]]) for j in range(num_examples)])
